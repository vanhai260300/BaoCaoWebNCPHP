<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			...
			<div class="ft col-xs-12 col-sm-12 col-md-3 col-lg-3">
				...
				<div class="contact">			
					<p class="bold">THE WEBSITE IS DESIGN BY TRÀ TẤN HIỆU</p>
					<p><i class="fa fa-map-marker"></i>Thăng Bình, Quảng Nam</p>
	              	<p><i class="fa fa-envelope"></i>Tratanhieu97@gmail.com</p>
